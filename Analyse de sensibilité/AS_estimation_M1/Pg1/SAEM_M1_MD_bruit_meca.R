...
SAEM <- function(niter,nburnin,M,data,paraminit,paramfix,delta){
  ...
  return(list(mul=mul,muH=muH,sigma2H=sigma2H,sigma2l=sigma2l,sigmaRes=sigmaRes,FIM=FIM))
}
