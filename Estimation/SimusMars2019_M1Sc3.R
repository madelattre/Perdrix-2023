...
for (N in c(20,50,100)){
  ...
  nameFile <- paste('resM1sc3bruit_N',N,'.Rdata',sep="")
  ...
  for (k in 1:nbsimus){
    ...
    paraminit[[k]] <- list(mul=runif(1,mu_lambda-0.5,mu_lambda+0.5),
                      ...
                      sigma2l=runif(1,0.8*sd2_lambda,2*sd2_lambda),
                      sigma2H=runif(1,0.8*sd2_ch,2*sd2_ch),
...
for (N in c(20,50,100)){
  ...
  nameFile <- paste('resM1sc3bruitmeca_N',N,'.Rdata',sep="")
